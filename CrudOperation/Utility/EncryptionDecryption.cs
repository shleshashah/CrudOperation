...
namespace CrudOperation.Utility
{
    ...
    {
        #region
        private const string key = "1prt56";
        #endregion

        #region Public Static Method(s)

        /// <summary>
        /// Decrypt value using TripleDES
        /// </summary>
        /// <param name="value">value to decrypt</param>
        /// <returns></returns>
        public static string DecryptValye(string DecryptText)
        {
            byte[] SrctArray;
        ...
        /// <summary>
        /// Encrypt value using TripleDES
        /// </summary>
        /// <param name="value">value to encrypt</param>
        /// <returns></returns>
        public static string EncryptValye(string Encryptval)
        {
            byte[] SrctArray;
